package com.mohnish.api2.controller;
...
import com.mohnish.api2.service.HobbyService;
...
public class HobbyController 
{
	...
	public ResponseEntity<String> findHobby(@PathVariable int personId)
	{
		...
		return new ResponseEntity<String>("Hobby not available",HttpStatus.NOT_FOUND);	
