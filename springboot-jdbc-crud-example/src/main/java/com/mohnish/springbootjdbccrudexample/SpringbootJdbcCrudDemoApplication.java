package com.mohnish.springbootjdbccrudexample;
...
import com.mohnish.springbootjdbccrudexample.repository.EmployeeJdbcRepository;

@SpringBootApplication
public class SpringbootJdbcCrudDemoApplication implements CommandLineRunner 
{
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringbootJdbcCrudDemoApplication.class, args);
	}
